...
from y9utils.general import LOGGER, colorstr, cv2
from y9utils.loggers.clearml.clearml_utils import ClearmlLogger
from y9utils.loggers.wandb.wandb_utils import WandbLogger
from y9utils.plots import plot_images, plot_labels, plot_results
from y9utils.torch_utils import de_parallel
...
try:
    if RANK not in [0, -1]:
        ...
        from y9utils.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from y9utils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
