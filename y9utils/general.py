...
from y9utils import TryExcept, emojis
from y9utils.downloads import gsutil_getsize
from y9utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from y9models.common import AutoShape, DetectMultiBackend
...
def strip_optimizer(f='best.pt', s=''):  # from y9utils.general import *; strip_optimizer()
